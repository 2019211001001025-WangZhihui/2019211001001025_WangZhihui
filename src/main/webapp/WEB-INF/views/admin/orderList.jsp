			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.wangzhihui.model.Order o=(com.wangzhihui.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.wangzhihui.Dao.UserDao userDao=new com.wangzhihui.Dao.UserDao();
						...
						<%
							...
							String paymentType=com.wangzhihui.model.Payment.findByPaymentId(con,n);
							 %>
